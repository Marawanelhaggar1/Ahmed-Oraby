  ...
  implements OnInit
{
  ...
  selection = new SelectionModel<SettingModel>(true, []);
  index?: number;
  id?: number;
  ...
  removeSelectedRows() {
    ...
    this.selection.selected.forEach((item) => {
      ...
      this.refreshTable();
      this.selection = new SelectionModel<SettingModel>(true, []);
    });
    // this.showNotification(
    //   'snackbar-danger',
...
export class ExampleDataSource extends DataSource<SettingModel> {
  ...
  filteredData: SettingModel[] = [];
  renderedData: SettingModel[] = [];
  constructor(
  ...
  connect(): Observable<SettingModel[]> {
  ...
  sortData(data: SettingModel[]): SettingModel[] {
