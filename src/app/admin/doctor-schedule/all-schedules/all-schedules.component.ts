  ...
  implements OnInit
{
  ...
  removeSelectedRows() {
    ...
    this.selection.selected.forEach((item) => {
      ...
      this.refreshTable();
      this.selection = new SelectionModel<ScheduleModel>(true, []);
    });
...
export class ExampleDataSource extends DataSource<ScheduleModel> {
  ...
  filteredData: ScheduleModel[] = [];
  renderedData: ScheduleModel[] = [];
  constructor(
  ...
  connect(): Observable<ScheduleModel[]> {
  ...
  sortData(data: ScheduleModel[]): ScheduleModel[] {
