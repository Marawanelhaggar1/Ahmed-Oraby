  ...
  implements OnInit
{
  ...
  removeSelectedRows() {
    ...
    this.selection.selected.forEach((item) => {
      ...
      this.refreshTable();
      this.selection = new SelectionModel<BookingModel>(true, []);
    });
    // this.showNotification(
    //   'snackbar-danger',
...
export class ExampleDataSource extends DataSource<BookingModel> {
  ...
  filteredData: BookingModel[] = [];
  renderedData: BookingModel[] = [];
  constructor(
  ...
  connect(): Observable<BookingModel[]> {
    ...
    return merge(...displayDataChanges).pipe(
      map(() => {
        ...
        this.filteredData = this.exampleDatabase.data
          .slice()
          .filter((centers: BookingModel) => {
            const searchStr = (
              centers.patient_name +
              centers.date +
              // centers.health_center.nameEn +
              centers.email +
              centers.status +
              centers.payment +
              centers.doctor.name +
  ...
  sortData(data: BookingModel[]): BookingModel[] {
