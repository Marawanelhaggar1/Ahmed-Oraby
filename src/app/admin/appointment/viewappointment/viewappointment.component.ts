  ...
  exportExcel() {
    ...
    const exportData: Partial<TableElement>[] =
      this.dataSource.filteredData.map((x) => ({
        UserFirstName: x.user.first_name,
        UserLastName: x.user.last_name,
        Email: x.user.email,
  ...
  sortData(data: Appointment[]): Appointment[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this._sort.active) {
        ...
        case 'time':
          [propertyA, propertyB] = [a.user.last_name, b.user.last_name];
          break;
        case 'mobile':
          [propertyA, propertyB] = [a.center.name, b.center.name];
          break;
      }
