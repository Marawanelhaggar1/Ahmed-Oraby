...
export class FormDialogComponent {
  ...
  constructor(
    ...
    private _doctorService: FeedbackServiceService
  ) {
    // Set the defaults
    ...
    if (this.action === 'edit') {
      ...
      this.dialogTitle = 'New Feedback';
      const blankObject = {} as FeedbackModel;
      this.doctors = new FeedbackModel(blankObject);
  ...
  updateDoctor(body: FeedbackModel) {
